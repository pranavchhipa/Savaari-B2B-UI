...
import {
  ...
  Printer, List, MinusCircle, ArrowLeftRight, Navigation, SlidersHorizontal} from 'lucide-angular';
  ...
  providers: [
    ...
    }),
    {
      ...
      useValue: new LucideIconProvider({
        ...
        Crosshair, AlertCircle, RefreshCw, Inbox,
        CalendarCheck, BarChart3, Percent, ChevronLeft,
        Printer, List, MinusCircle, ArrowLeftRight, Navigation, SlidersHorizontal      })
    }
  ]
};
