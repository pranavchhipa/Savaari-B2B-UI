...
export class ValuePropsComponent {
    props = [
        ...
        { icon: 'wallet', title: "Flexible Wallet System", description: "Add funds and pay easily with a seamless wallet experience.", highlight: "Instant Payments", accent: 'amber' },
